  ...
  return <section className="report-section" id="report">
    ...
    <div className="report-window">
      ...
      <div className="report-body">
        <aside className="report-sidebar"><div className="report-brand"><ShieldCheck size={18} /> ContractIQ</div><span className="sidebar-active"><FileText size={15} /> Overview</span><span><CircleDollarSign size={15} /> Financial terms</span><span><AlertTriangle size={15} /> Risk flags <b>2</b></span><span><Check size={15} /> Recommendations</span></aside>
